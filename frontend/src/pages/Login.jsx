...
const Login = () => {
  return (
    ...
    <div
        ...
        className="container flex mt-3 justify-center min-h-screen px-6 mx-auto">
        <form className="w-full max-w-md">
            ...
            <div className="mt-6">
                ...
                <a href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-white transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 hover:text-black ">
