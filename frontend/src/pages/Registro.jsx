        ...
        <div className="container flex mt-16 justify-center ml-6 min-h-screen px-6 ">
            <form className="w-full max-w-md">
                <div className="flex items-center justify-center mt-6 relative">
                    <a
                        href="#" onClick={handleAdminClick}
                        className={`w-1/3 pb-4 font-medium text-center capitalize border-b ${showAdminLogin ? "text-gray-800 border-blue-500" : "text-gray-500"}`}
                    >
                        Administrador
                    </a>

                    <a
                        href="#" onClick={handleUserClick}
                        className={`w-1/3 pb-4 font-medium text-center capitalize border-b ${!showAdminLogin ? "text-gray-800 border-blue-500" : "text-gray-500"}`}
                    >
                        Usuario
                    </a>
                ...
                {showAdminLogin ? (
                    <>
                        ...
                        <div className="relative flex items-center mt-8">
                            ...
                            <input type="text" name="nombre" value={adminData.nombre} onChange={handleAdminChange}
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type="email" name="email" value={adminData.email} onChange={handleAdminChange}
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type={showPassword ? 'text' : 'password'} name="password" value={adminData.password} onChange={handleAdminChange}
                                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type={showConfirmPassword ? 'text' : 'password'} name="confirmarPassword" value={adminData.confirmarPassword} onChange={handleAdminChange}
                                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
                    ...
                    <>
                        ...
                        <div className="relative flex items-center mt-8">
                            ...
                            <input type="text" name="nombre" value={userData.nombre} onChange={handleUserChange}
                                className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 focus:border-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type={showPassword ? 'text' : 'password'} name="password" value={userData.password} onChange={handleUserChange}
                                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type={showConfirmPassword ? 'text' : 'password'} name="confirmarPassword" value={userData.confirmarPassword} onChange={handleUserChange}
                                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
                                placeholder="Confirmar Contraseña"
                            />
                            <span onClick={toggleConfirmPasswordVisibility} className="absolute right-3 cursor-pointer">
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type="text" name="antiguedad" value={userData.antiguedad} onChange={handleUserChange}
                                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
